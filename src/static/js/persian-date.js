...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	/******/ 	};
	/******/ 	// ...existing code...
	/******/ 	// Simplify the `toPersianDigit` function
	/******/ 	function toPersianDigit(digit, latinDigit = false) {
	/******/ 		return digit.toString().replace(/\d+/g, (match) => {
	/******/ 			return [...match].map((char) => 
	/******/ 				String.fromCharCode(char.charCodeAt(0) + (latinDigit ? 1584 : 1728))
	/******/ 			).join('');
	/******/ 		});
	/******/ 	}
	/******/ 	// ...existing code...
