...
(function() {
	...
	window.wireguard = {
		/**
		 * Generate a keypair including private, public, and preshared keys.
		 * @returns {Object} An object containing base64-encoded keys.
		 */
		...
		/**
		 * Generate a ZIP file containing peer configuration files.
		 * @param {Object} res - Object containing peers and filename.
		 */
