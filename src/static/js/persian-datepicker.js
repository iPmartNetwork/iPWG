...
var Helper = {
    ...
    /**
     * @desc Adjust the weekdays array based on the first day of the week
     * @param weekdays - Array of weekdays
     * @param firstDay - Index of the first day (0 for Sunday, 1 for Monday, etc.)
     * @return {Array} - Adjusted weekdays array
     */
    adjustWeekdays: function(weekdays, firstDay) {
...
var Config = {
  ...
  /**
   * @description Set the first day of the week (0 for Sunday, 1 for Monday, etc.)
   * @type {number}
   * @default 6 (Saturday for Persian calendar)
   */
  'firstDayOfWeek': 6
};
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(exports, "__esModule", { value: true }); Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var State = function () {
    ...
    function State(model) {
         ...
         * @type {{year: number, month: number, date: number, hour: number, hour12: number, minute: number, second: number, unixDate: number, dateObject: null}}
         */
        this.selected = {
            year: 0,
            month: 0,
...
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true; _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { _n = false; _e = undefined; } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(exports, __esModule", { value: true }); Object.defineProperty(target, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
